// ui-library — shadcn/ui component library (Base UI variant).
//
// Components are generated by the shadcn CLI into `src/components/ui` (see the
// root `components.json`, whose aliases point at `@zero-app/ui-library/*`).
