...
export interface Conditions {
	...
	"_groupTabs": string
	/** `.group\/tabs-list &` */
	"_groupTabsList": string
	/** `.group\/accordion-trigger &` */
	"_groupAccordionTrigger": string
	/** `.group\/avatar &` */
	"_groupAvatar": string
	/** `.group\/avatar-group &` */
	"_groupAvatarGroup": string
	/** `.group\/field-group &` */
	"_groupFieldGroup": string
	/** `.group\/field &` */
	"_groupField": string
	/** `.group\/switch &` */
	"_groupSwitch": string
	/** `.group\/sidebar &` */
	"_groupSidebar": string
	/** `.group\/sidebar-wrapper &` */
	"_groupSidebarWrapper": string
	/** `.group\/toggle &` */
	"_groupToggle": string
	/** `.group\/sidebar-menu &` */
	"_groupSidebarMenu": string
	/** `&[aria-invalid='true']` */
	"_ariaInvalid": string
	/** `&[aria-expanded='true']` */
	"_ariaExpanded": string
	/** `&[aria-pressed='true']` */
	"_ariaPressed": string
	/** `&[aria-disabled='true']` */
	"_ariaDisabled": string
	/** `&[aria-selected='true']` */
	"_ariaSelected": string
	/** `&[aria-haspopup]` */
	"_ariaHaspopup": string
	/** `&[data-active]` */
	"_dataActive": string
	/** `&[data-open]` */
	"_dataOpen": string
	...
	"_dataChecked": string
	/** `&[data-unchecked]` */
	"_dataUnchecked": string
	/** `&[data-disabled]` */
	"_dataDisabled": string
	/** `&[data-starting-style]` */
	"_dataStartingStyle": string
	/** `&[data-ending-style]` */
	"_dataEndingStyle": string
	/** `&[data-orientation='horizontal']` */
	"_dataHorizontal": string
	/** `&[data-orientation='vertical']` */
	"_dataVertical": string
	/** `&[data-size='default']` */
	"_dataSizeDefault": string
	/** `&[data-size='sm']` */
	"_dataSizeSm": string
	/** `&[data-size='lg']` */
	"_dataSizeLg": string
	/** `&[data-variant='line']` */
	"_dataVariantLine": string
	/** `&[data-state='expanded']` */
	"_dataSidebarExpanded": string
	/** `&[data-state='collapsed']` */
	"_dataSidebarCollapsed": string
