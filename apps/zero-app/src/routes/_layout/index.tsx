  ...
  return (
    <>
      <div className={css({ display: 'flex', alignItems: 'center', gap: '3' })}>
        ...
        {!isSignedIn && (
          <span className={css({ fontSize: 'sm', color: 'var(--sea-ink-soft)' })}>Sign in to add an album.</span>
        )}
      </div>
      ...
      {error && (
        <div
          ...
          className={css({
            ...
            borderRadius: 'md',
            borderWidth: '1px',
            borderColor: 'color-mix(in oklch, #ef4444 40%, transparent)',
            bg: 'color-mix(in oklch, #ef4444 10%, transparent)',
            px: '3',
            py: '2',
            fontSize: 'sm',
            color: '#dc2626',
